...
"""
App file that runs the uses the blockchain class to activate and run the blockchain

ALL BLOCKCHAIN FUNCTIONS
...
http://localhost:5000/nodes/resolve - resolves any discrepancies with the blockchain
...
def mine():
    ...
    # Miner will get 1 coin as a reward for mining the block
